...
namespace DabloonsPP.GameObjects.Towers
{
    class BasicTower : ITower
    {
        ...
        public BasicTower(int x, int y, Canvas canva, int damage, List<Bloon> enemies, TryReduceMoney tryReduceMoney, changeMenu OpenUpgradeMenu) : 
            base(width, height, (x-(width/2)), (y-(height/2)), "Monkeys\\dartMonkey.png", canva, damage, 200, enemies, TimeSpan.FromMilliseconds(750), tryReduceMoney, OpenUpgradeMenu)
        {
